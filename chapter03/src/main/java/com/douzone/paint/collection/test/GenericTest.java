...
//		drawShape(new Point()); // error
	...
	public static <T extends Shape> void drawShape(T t) {
		...
		MyStack<? extends Shape> s01 = null;
		MyStack<? super Shape> s02 = null;
		
		List<Rect> list1 = new ArrayList<>();
		List<Shape> list2 = new ArrayList<>();
		
		MyStack<Drawable> s = new MyStack<>();
...
//	}
	...
	public static void drawShaperLayer(
			List<? extends Shape> in, // Producer, LowerBounded
